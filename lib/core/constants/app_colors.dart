...
class AppColors {
  ...
  static const darkRealLightGreyColor = Color(0xFFBBBBBB);
  static const darkLightGreyColor = Color(0xFF737373);
  static const darkGreyColor = Color.fromARGB(255, 73, 73, 73);
